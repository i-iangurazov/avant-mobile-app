...
try{
 const routes=[['GET','/admin/orders'],['GET','/admin/orders/missing'],['GET','/admin/account-recovery'],['POST','/admin/account-recovery/approve'],['GET','/admin/program'],['GET','/admin/plumbers'],['PATCH','/admin/plumbers/missing/status'],['GET','/admin/loyalty/config'],['PATCH','/admin/loyalty/config'],['POST','/admin/loyalty/release'],['POST','/admin/receipts'],['POST','/admin/returns'],['POST','/admin/loyalty/adjustments'],['GET','/admin/leads'],['GET','/admin/leads/missing/candidates'],['POST','/admin/leads/missing/assign'],['PATCH','/admin/reviews/missing'],['POST','/admin/rewards'],['PUT','/admin/rewards'],['PATCH','/admin/redemptions/missing/status'],['POST','/admin/promotions'],['PUT','/admin/promotions'],['POST','/admin/exclusions'],['PUT','/admin/exclusions'],['POST','/admin/content'],['PUT','/admin/content']];
